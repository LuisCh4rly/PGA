...
class GrupoController {
    ...
    @PostMapping
    public ResponseEntity<GrupoResponseDto> crearActividadBase (@RequestBody @Valid GrupoRequestDto dto){
    ...
    public ResponseEntity< GrupoResponseDto > habilitarDeshabilitarActividadBase (@PathVariable Long id){
        return ResponseEntity
                .status(HttpStatus.OK)
